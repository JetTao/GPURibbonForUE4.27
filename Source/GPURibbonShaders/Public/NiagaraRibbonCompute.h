...
BEGIN_SHADER_PARAMETER_STRUCT(FRibbonComputeUniformParameters, GPURIBBONSHADERS_API)
...
BEGIN_SHADER_PARAMETER_STRUCT(FRibbonOrderSortParameters, GPURIBBONSHADERS_API)
...
*/
class GPURIBBONSHADERS_API FNiagaraRibbonSortPhase1CS : public FGlobalShader
{
...
* Compute shader used to generate particle sort keys.
*/
class GPURIBBONSHADERS_API FNiagaraRibbonSortPhase2CS : public FGlobalShader
{
...
BEGIN_SHADER_PARAMETER_STRUCT(FNiagaraRibbonVertexReductionParameters, GPURIBBONSHADERS_API)
	SHADER_PARAMETER_STRUCT_INCLUDE(FRibbonComputeUniformParameters, Common)
	SHADER_PARAMETER_SRV(Buffer<uint32>, SortedIndices)
...
class GPURIBBONSHADERS_API FNiagaraRibbonVertexReductionInitializationCS : public FGlobalShader
{
...
class GPURIBBONSHADERS_API FNiagaraRibbonVertexReductionPropagateCS : public FGlobalShader
{
...
BEGIN_SHADER_PARAMETER_STRUCT(FNiagaraRibbonVertexReductionFinalizationParameters, GPURIBBONSHADERS_API)
	SHADER_PARAMETER_STRUCT_INCLUDE(FRibbonComputeUniformParameters, Common)
	SHADER_PARAMETER_SRV(Buffer<uint32>, SortedIndices)
...
class GPURIBBONSHADERS_API FNiagaraRibbonVertexReductionFinalizeCS : public FGlobalShader
{
...
BEGIN_SHADER_PARAMETER_STRUCT(FNiagaraGPURibbonUVSettingsParams, GPURIBBONSHADERS_API)
...
BEGIN_SHADER_PARAMETER_STRUCT(FNiagaraRibbonVertexFinalizationParameters, )
	SHADER_PARAMETER_STRUCT_INCLUDE(FRibbonComputeUniformParameters, Common)
	SHADER_PARAMETER_STRUCT(FNiagaraGPURibbonUVSettingsParams, UV0Settings)
	SHADER_PARAMETER_STRUCT(FNiagaraGPURibbonUVSettingsParams, UV1Settings)
	SHADER_PARAMETER_SRV(Buffer<uint32>, SortedIndices)
...
class GPURIBBONSHADERS_API FNiagaraRibbonUVParamCalculationCS : public FGlobalShader
{
...
BEGIN_SHADER_PARAMETER_STRUCT(FNiagaraRibbonInitializeIndices, GPURIBBONSHADERS_API)
	...
	SHADER_PARAMETER(uint32, GNiagaraGPURibbonMaxTessellation)
	SHADER_PARAMETER(float, GNiagaraGPURibbonTessellationAngle)
	SHADER_PARAMETER(float, GNiagaraGPURibbonTessellationScreenPercentage)
	SHADER_PARAMETER(uint32, GNiagaraGPURibbonTessellationEnabled)
	SHADER_PARAMETER(float, GNiagaraGPURibbonTessellationMinDisplacementError)
END_SHADER_PARAMETER_STRUCT()

class GPURIBBONSHADERS_API FNiagaraRibbonCreateIndexBufferParamsCS : public FGlobalShader
{
...
BEGIN_SHADER_PARAMETER_STRUCT(FNiagaraRibbonGenerateIndices, GPURIBBONSHADERS_API)
...
class GPURIBBONSHADERS_API FNiagaraRibbonCreateIndexBufferCS : public FGlobalShader
{
