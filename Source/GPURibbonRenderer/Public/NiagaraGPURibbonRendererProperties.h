...
UENUM()
enum class ENiagaraGPURibbonFacingMode : uint8
{
...
UENUM()
enum class ENiagaraGPURibbonAgeOffsetMode : uint8
{
...
UENUM()
enum class ENiagaraGPURibbonDrawDirection : uint8
{
	FrontToBack,
	BackToFront
};
...
UENUM()
enum class ENiagaraGPURibbonShapeMode : uint8
{
...
USTRUCT()
struct FNiagaraGPURibbonShapeCustomVertex
{
	GENERATED_BODY();
	FNiagaraGPURibbonShapeCustomVertex();
...
UENUM()
enum class ENiagaraGPURibbonTessellationMode : uint8
{
...
UENUM()
enum class ENiagaraGPURibbonUVEdgeMode
{
...
UENUM()
enum class ENiagaraGPURibbonUVDistributionMode
{
...
USTRUCT()
struct FNiagaraGPURibbonUVSettings
{
	GENERATED_BODY();

	FNiagaraGPURibbonUVSettings();
	...
	ENiagaraGPURibbonUVDistributionMode DistributionMode;

	/** Specifies how UVs transition into life at the leading edge of the ribbon. */
	UPROPERTY(EditAnywhere, Category = UVs, meta = (DisplayName="Leading Edge Transition", EditCondition = "!bEnablePerParticleUOverride && DistributionMode != ENiagaraGPURibbonUVDistributionMode::TiledFromStartOverRibbonLength"))
	ENiagaraGPURibbonUVEdgeMode LeadingEdgeMode;

	/** Specifies how UVs transition out of life at the trailing edge of the ribbon. */
	UPROPERTY(EditAnywhere, Category = UVs, meta = (DisplayName="Trailing Edge Transition", EditCondition = "!bEnablePerParticleUOverride && DistributionMode != ENiagaraGPURibbonUVDistributionMode::TiledOverRibbonLength && DistributionMode != ENiagaraGPURibbonUVDistributionMode::TiledFromStartOverRibbonLength"))
	ENiagaraGPURibbonUVEdgeMode TrailingEdgeMode;
	...
	UPROPERTY(EditAnywhere, Category = UVs, meta = (EditCondition="!bEnablePerParticleUOverride && DistributionMode == ENiagaraGPURibbonUVDistributionMode::TiledOverRibbonLength || DistributionMode == ENiagaraGPURibbonUVDistributionMode::TiledFromStartOverRibbonLength"))
	float TilingLength;
...
namespace ENiagaraGPURibbonVFLayout
{
	enum Type
	{
		Position,
...
UCLASS(editinlinenew, meta = (DisplayName = "GPU Ribbon Renderer"))
class UNiagaraGPURibbonRendererProperties : public UNiagaraRendererProperties
{
public:
	GENERATED_BODY()

	UNiagaraGPURibbonRendererProperties();
	...
	virtual bool IsSimTargetSupported(ENiagaraSimTarget InSimTarget) const override { return InSimTarget == ENiagaraSimTarget::GPUComputeSim; };
...
private:
	...
	UPROPERTY()
	ENiagaraGPURibbonAgeOffsetMode UV0AgeOffsetMode_DEPRECATED;
	...
	UPROPERTY()
	ENiagaraGPURibbonAgeOffsetMode UV1AgeOffsetMode_DEPRECATED;
#endif
...
public:
	...
	*/ 
	...
	/** Double geometry count, to allow for correct geometry on both sides of MultiPlane. With this off, 
	  ...
	  */
	UPROPERTY(EditAnywhere, Category = "Ribbon Shape", meta = (EditCondition = "Shape == ENiagaraGPURibbonShapeMode::MultiPlane"))
	...
	*/
	UPROPERTY(EditAnywhere, Category = "Ribbon Shape", meta = (EditCondition = "Shape == ENiagaraGPURibbonShapeMode::Plane || Shape == ENiagaraGPURibbonShapeMode::MultiPlane", ClampMin = "1", ClampMax = "16"))
	...
	UPROPERTY(EditAnywhere, Category = "Ribbon Shape", meta = (EditCondition = "Shape == ENiagaraGPURibbonShapeMode::MultiPlane", ClampMin = "2", ClampMax = "8"))
	int32 MultiPlaneCount;

	/** Number of vertices/faces in a tube.  */
	UPROPERTY(EditAnywhere, Category = "Ribbon Shape", meta = (EditCondition = "Shape == ENiagaraGPURibbonShapeMode::Tube", ClampMin = "3", ClampMax = "16"))
	int32 TubeSubdivisions;

	/** Vertices for a cross section of the ribbon in custom shape mode. */
	UPROPERTY(EditAnywhere, Category = "Ribbon Shape", meta = (EditCondition = "Shape == ENiagaraGPURibbonShapeMode::Custom"))
	TArray<FNiagaraGPURibbonShapeCustomVertex> CustomVertices;
...
private: 
	static TArray<TWeakObjectPtr<UNiagaraGPURibbonRendererProperties>> RibbonRendererPropertiesToDeferredInit;
};
