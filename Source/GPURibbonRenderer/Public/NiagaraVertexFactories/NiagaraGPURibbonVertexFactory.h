...
*/
BEGIN_GLOBAL_SHADER_PARAMETER_STRUCT(FNiagaraGPURibbonUniformParameters, )
...
BEGIN_GLOBAL_SHADER_PARAMETER_STRUCT(FNiagaraGPURibbonVFLooseParameters, )
...
*/
class FNiagaraGPURibbonVertexFactory : public FNiagaraVertexFactoryBase
{
