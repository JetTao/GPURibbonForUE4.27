...
BEGIN_SHADER_PARAMETER_STRUCT(FRibbonComputeUniformParameters, )
...
BEGIN_SHADER_PARAMETER_STRUCT(FRibbonOrderSortParameters, )
...
BEGIN_SHADER_PARAMETER_STRUCT(FNiagaraRibbonVertexReductionParameters, )
	SHADER_PARAMETER_STRUCT_INCLUDE(FRibbonComputeUniformParameters, Common)
	SHADER_PARAMETER_SRV(Buffer<uint32>, SortedIndices)
...
BEGIN_SHADER_PARAMETER_STRUCT(FNiagaraRibbonVertexReductionFinalizationParameters, )
	SHADER_PARAMETER_STRUCT_INCLUDE(FRibbonComputeUniformParameters, Common)
	SHADER_PARAMETER_SRV(Buffer<uint32>, SortedIndices)
...
BEGIN_SHADER_PARAMETER_STRUCT(FNiagaraGPURibbonUVSettingsParams, )
...
BEGIN_SHADER_PARAMETER_STRUCT(FNiagaraRibbonInitializeIndices, )
...
BEGIN_SHADER_PARAMETER_STRUCT(FNiagaraRibbonGenerateIndices, )
