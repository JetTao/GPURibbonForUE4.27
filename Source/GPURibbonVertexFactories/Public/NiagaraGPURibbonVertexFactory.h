...
//	FNiagaraGPURibbonVertexDynamicParameter
struct FNiagaraGPURibbonVertexDynamicParameter
{
...
*/
BEGIN_GLOBAL_SHADER_PARAMETER_STRUCT(FNiagaraGPURibbonUniformParameters, GPURIBBONVERTEXFACTORIES_API)
...
typedef TUniformBufferRef<FNiagaraGPURibbonUniformParameters> FNiagaraGPURibbonUniformBufferRef;

BEGIN_GLOBAL_SHADER_PARAMETER_STRUCT(FNiagaraGPURibbonVFLooseParameters, GPURIBBONVERTEXFACTORIES_API)
...
END_GLOBAL_SHADER_PARAMETER_STRUCT()
typedef TUniformBufferRef<FNiagaraGPURibbonVFLooseParameters> FNiagaraGPURibbonVFLooseParametersRef;

/**
* Beam/Trail particle vertex factory.
*/
class GPURIBBONVERTEXFACTORIES_API FNiagaraGPURibbonVertexFactory : public FNiagaraVertexFactoryBase
{
	DECLARE_VERTEX_FACTORY_TYPE(FNiagaraGPURibbonVertexFactory);

public:

	/** Default constructor. */
	FNiagaraGPURibbonVertexFactory(ENiagaraVertexFactoryType InType, ERHIFeatureLevel::Type InFeatureLevel)
		: FNiagaraVertexFactoryBase(InType, InFeatureLevel)
		, DataSet(nullptr)
	{}

	FNiagaraGPURibbonVertexFactory()
	...
	*/
	FORCEINLINE void SetRibbonUniformBuffer(FNiagaraGPURibbonUniformBufferRef InSpriteUniformBuffer)
	{
	...
	*/
	FORCEINLINE FNiagaraGPURibbonUniformBufferRef GetRibbonUniformBuffer()
	{
...
private:
	...
	FNiagaraGPURibbonUniformBufferRef NiagaraRibbonUniformBuffer;
